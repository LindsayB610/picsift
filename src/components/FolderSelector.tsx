        ...
        {needsRefreshToken && (
          ...
          >
            ...
            <ol style={{ margin: "0.5rem 0 0 1rem", paddingLeft: "0.5rem" }}>
              <li>
                Go to{" "}
                <strong>https://picsift.lindsaybrunner.com/?reauth=true</strong>{" "}
                and click Login with Dropbox again.
              </li>
              <li>
                After Dropbox redirects you back, go to <strong>Netlify</strong>{" "}
                → your PicSift site → <strong>Functions</strong> →{" "}
                <strong>auth_callback</strong> → <strong>Logs</strong>.
              </li>
              <li>
                Find the line that says <code>DROPBOX_REFRESH_TOKEN=...</code>{" "}
                and copy the full value after the <code>=</code>.
              </li>
              <li>
                In Netlify go to <strong>Site configuration</strong> →{" "}
                <strong>Environment variables</strong>. Add{" "}
                <code>DROPBOX_REFRESH_TOKEN</code> with that value, and{" "}
                <code>AUTHORIZED_DROPBOX_ACCOUNT_ID</code> (from the log line
                above it).
              </li>
              <li>
                <strong>Deploys</strong> → <strong>Trigger deploy</strong> →{" "}
                <strong>Deploy site</strong>. When it finishes, click Retry
                below.
              </li>
            </ol>
          </div>
    ...
    >
      <div>
        ...
        <p style={{ margin: 0, color: "var(--text)", fontSize: "0.9375rem" }}>
          Choose a folder to review photos from. Folders are sorted by number of
          images.
        </p>
      </div>
